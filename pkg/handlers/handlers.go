...
import (
	...
	"github.com/aws/aws-lambda-go/events" // Package for getting and returning events from the API Gateway.
...
func UnhandledMethod(req events.APIGatewayProxyRequest, tableName string, dynaClient dynamodbiface.DynamoDBAPI) (*events.APIGatewayProxyResponse, error) {
